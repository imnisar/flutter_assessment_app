...
extension UserLocalModelByIndex on IsarCollection<UserLocalModel> {
  Future<UserLocalModel?> getByUid(String uid) {
    return getByIndex(r'uid', [uid]);
  }

  UserLocalModel? getByUidSync(String uid) {
  ...
  Future<List<UserLocalModel?>> getAllByUid(List<String> uidValues) {
    final values = uidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uid', values);
  }

  List<UserLocalModel?> getAllByUidSync(List<String> uidValues) {
    final values = uidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUid(UserLocalModel object) {
    return putByIndex(r'uid', object);
  }

  Id putByUidSync(UserLocalModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'uid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUid(List<UserLocalModel> objects) {
    return putAllByIndex(r'uid', objects);
  }

  List<Id> putAllByUidSync(List<UserLocalModel> objects,
      {bool saveLinks = true}) {
...
extension UserLocalModelQueryWhere
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterWhereClause> uidEqualTo(
      String uid) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterWhereClause> uidNotEqualTo(
      String uid) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension UserLocalModelQuerySortBy
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> sortByBirthday() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> sortByUid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uid', Sort.asc);
    });
  }

  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> sortByUidDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserLocalModelQuerySortThenBy
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> thenByBirthday() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'birthday', Sort.asc);
    });
  }
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> thenByUid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uid', Sort.asc);
    });
  }

  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> thenByUidDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uid', Sort.desc);
    });
  }
...
extension UserLocalModelQueryWhereDistinct
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QDistinct> distinctByBirthday(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QDistinct> distinctByUid(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserLocalModelQueryProperty
  ...
  QueryBuilder<UserLocalModel, String, QQueryOperations> birthdayProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, String, QQueryOperations> uidProperty() {
    return QueryBuilder.apply(this, (query) {
